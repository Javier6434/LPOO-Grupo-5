...
namespace TecHouseView {
	...
	/// <summary>
	/// Resumen de frmEditarCasa
	/// </summary>
	public ref class frmEditarCasa : public System::Windows::Forms::Form
	{
	public:
		frmEditarCasa(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(249, 289);
			...
			this->button2->Click += gcnew System::EventHandler(this, &frmEditarCasa::button2_Click);
			// 
			// button1
			// 
			this->button1->Location = System::Drawing::Point(114, 289);
			...
			this->button1->Click += gcnew System::EventHandler(this, &frmEditarCasa::button1_Click);
			// 
			// groupBox1
			// 
			...
			this->ClientSize = System::Drawing::Size(436, 340);
...
#pragma endregion
	...
	private: System::Void frmEditarCasa_Load(System::Object^ sender, System::EventArgs^ e) {
		this->textBox1->Text = Convert::ToString(this->objCasa->getCodigo());
		this->textBox2->Text = this->objCasa->getDepartamento();
		this->textBox3->Text = this->objCasa->getDistrito();
		this->textBox4->Text = this->objCasa->getAvenida();
		this->textBox5->Text = Convert::ToString(this->objCasa->getcantAmbientes());
	}
};
}
