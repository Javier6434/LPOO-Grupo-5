...
namespace TecHouseView {
	...
	/// <summary>
	/// Resumen de frmNuevoUsuarioAdmi
	/// </summary>
	public ref class frmNuevoUsuarioAdmi : public System::Windows::Forms::Form
	{
	public:
		frmNuevoUsuarioAdmi(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(235, 476);
			...
			this->button2->Click += gcnew System::EventHandler(this, &frmNuevoUsuarioAdmi::button2_Click);
			// 
			// button1
			// 
			this->button1->Location = System::Drawing::Point(119, 476);
			...
			this->button1->Click += gcnew System::EventHandler(this, &frmNuevoUsuarioAdmi::button1_Click);
			// 
			// groupBox2
			// 
			...
			this->groupBox2->Location = System::Drawing::Point(24, 233);
			...
			this->groupBox1->Location = System::Drawing::Point(24, 20);
			...
			this->ClientSize = System::Drawing::Size(444, 509);
			this->Controls->Add(this->button2);
			this->Controls->Add(this->button1);
			this->Controls->Add(this->groupBox2);
			this->Controls->Add(this->groupBox1);
			this->Name = L"frmNuevoUsuarioAdmi";
			this->Text = L"frmNuevoUsuarioAdmi";
